 ...
 * Artyom.js can be used in Chromium Based Browsers.
 *
...
((window) => {'use strict';
    ...
    function ArtyomAI(){
             ...
             * @returns {undefined}
             */
            artyom.addCommands = (param) => {
                var _processObject = (obj) => {
             ...
             * @returns {array}
             */
            artyom.removeCommands = (identifier) => {
             ...
             * @returns {undefined}
             */
            var artyom_triggerEvent = (name,param) => {
             ...
             * @returns {undefined}
             */
            var artyom_talk = (text,actualChunk,totalChunks,callbacks) => {
                    ...
                    if(typeof(message) == 'string'){
                        if(message.length > 0){
                            ...
                            if((finalTextA.length) > (finalTextB.length)){
                                definitive = finalTextA.filter(e => e);
                            }else{
                                definitive = finalTextB.filter(e => e);
                            }
             ...
             */
            artyom.repeatLastSay = (returnObject) => {
             ...
             * @returns {undefined}
             */
            artyom.simulateInstruction = (sentence) => {
             ...
             * @returns {undefined}
             */
            artyom.redirectRecognizedTextOutput = (action) => {
